...
parser.add_argument('--port-number', type=int, default=8080, help='port')
...
parser.add_argument('--exec_file', type=str, default='../../linux_exec.v2.3.0.x86_64', help='Path to the executable')
...
if __name__ == "__main__":
    ...
    pickle.dump(test_set, open(f'{curr_dir}/../dataset/new_dataset_test.pik', 'wb'))